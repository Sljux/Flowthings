...
extension FTDropDelete {
    ...
    func testDropCreateAndDelete_positive() {
        ...
        let expectation = expectationWithDescription("Calling drop.create then drop.delete")
        ...
        api.drop.create(byFlowId: conf.flowID, params: params)
            .then { json -> FTStream in
                ...
                return self.api.drop.delete(conf.flowID, id: id)
            }
            .then  { json -> () in
